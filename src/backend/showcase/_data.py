...
CHECKS: tuple[Check, ...] = (
    Check(
        ...
        "parity, the machine-readable module contract, Makefile help parity, cross-reference resolution, check-catalogue parity, rosters and practice mechanisms (checks A–T).",
    ),
    Check(
        slug="python-floor",
